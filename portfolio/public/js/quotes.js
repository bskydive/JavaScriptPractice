var quotes = [
    ["Олег Янковский", "http://www.adme.ru/tvorchestvo-kino/15-genialnyh-citat-olega-yankovskogo-797860/",
        "В культуру надо вкладывать огромные деньги. Без этого ничего не будет. Бриллиантов у нас много, но никто не хочет браться за их огранку: черпаем ковшом и отдаем за две копейки. Глупо.",
        ...
        "Я никогда не «нагружаю» окружающих своими проблемами. Я их стараюсь скрыть.",
        "Если смотреть только вниз, то можно замычать.",
        "В те времена девушки совсем другим брали...Нет, визуальные эффекты тоже были...все девушки очень красивые были. В цене всегда были чистота и огонь внутренний.",
        ...
        "Много на свете красивых женщин, но разрушать семью все же не надо.",
        "Играть вполноги хороший артист просто не сможет. Это не связано с возрастом. Актер обязательно должен излучать энергетику. Ты выходишь на сцену — и начинают по-другому работать селезенка, печень, нервная система.",
        "Не эпоха определяет спектакль. Играется человеческая боль, а она в любые времена остается болью. Поэтому во фраке я играю Протасова или в джинсах «Полеты во сне и наяву» — темы приблизительно одинаковые.",
        "Я давно уже для себя решил: чем шире аудитория у артиста, тем больше он должен чувствовать ответственность за то, что делает.",
        ...
        "Моя профессия — любить! Я не представляю себя без любви. Без любви в самом высоком значении этого слова в нашем деле невозможно."
    ],
    ...
    ["Михаил Жванецкий", "http://www.adme.ru/tvorchestvo-pisateli/30-genialnyh-citat-mihaila-zhvaneckogo-867060/",
